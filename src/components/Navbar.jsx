...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-12 bg-[#203A43] text-pink-300 text-lg">
      <div>
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-[#203A43] flex flex-col justify-center items-center"
        }
      >
